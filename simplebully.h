...
#define SIMPLEBULLY_H_
	...
	#define THRESHOLD 0.80					// probability of a node deciding to partipicating in a leader election
	...
	int MAX_ROUNDS = 10;					// number of rounds to run the algorithm - should be modified from command-line
